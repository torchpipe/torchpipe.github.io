...
### 不同batchsize的客户端
在[此处例子](https://github.com/torchpipe/torchpipe/-/blob/master/examples/yolox/yolox_multithreads_test.py)中，我们使用十个客户端，客户端每次请求的数据量分别为1，2，3，...10。我们验证了在这种情况下结果的一致性。
